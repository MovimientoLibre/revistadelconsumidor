...
class Imprenta extends \Base\ImprentaPublicaciones {
    ...
    public function __construct() {
        ...
        $this->publicaciones_directorio = 'PlatilloSabio';
        // Los siguientes parámetros dan datos para el concentrador y las páginas que no los tienen
        $this->titulo                   = 'Platillo Sabio';
        $this->descripcion              = 'Deliciosas recetas de platillos donde el sabor y la economomía van de la mano.';
        $this->claves                   = 'Platillo, Sabio, Recetas, Cocina';
        ...
        $this->directorio               = 'platillo-sabio';
